...
import com.example.piyush.todolist.Adapter.ListItemAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    updataData(title.getText().toString(),description.getText().toString());
                    isUpdated=!isUpdated;
                }
    ...
    private void updataData(String title, String description) {
